...
@app.get("/db/getOne_spPosQuotFra/{spPosQuotFra_id}", response_model=schemas.SpPosQuotFra)
...
def readAll_spPosQuotFra(skip: int = 0, limit: int = 500, db: Session = Depends(get_db)):
...
def create_spPosQuotFra(spPosQuotFraCreate: schemas.SpPosQuotFraCreate, db: Session = Depends(get_db)):
