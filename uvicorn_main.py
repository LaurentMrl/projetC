...
def start_server_fastapi(host="127.0.0.1",
                         port=8000,
                         num_workers=4,
                         loop="asyncio",
                         reload=True):
    uvicorn.run("sql_app.main:app",
                host=host,
                port=port,
                workers=num_workers,
                loop=loop,
...
def start_server_web(host="127.0.0.1",
                         port=8080,
                         num_workers=4,
                         loop="asyncio",
                         reload=True):
...
def start_server_retrieve_csv_and_request_db(host="127.0.0.1",
                         port=9000,
                         num_workers=4,
                         loop="asyncio",
                         reload=True):
    uvicorn.run("data_retrieve.main:app",
                host=host,
                port=port,
                workers=num_workers,
                loop=loop,
